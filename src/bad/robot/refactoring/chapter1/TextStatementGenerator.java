...
public class TextStatementGenerator extends StatementGenerator {
    ...
    private static final String FOOTER_TEMPLATE =
            "Amount owed is %1s\nYou earned %2d frequent renter points\n";
    private static final TextStatementGenerator INSTANCE = new TextStatementGenerator();

    public static final TextStatementGenerator getInstance() {
        return INSTANCE;
    }
